...
namespace Nocubeless
{
    internal class CameraInput : NocubelessComponent
    {
        ...
        private void Move(GameTime gameTime)
        {
            ...
            if (GameInput.CurrentKeyboardState.IsKeyDown(Nocubeless.Settings.Keys.MoveBackward)) 
            ...
            if (GameInput.CurrentKeyboardState.IsKeyDown(Nocubeless.Settings.Keys.MoveLeft)) 
            ...
            if (GameInput.CurrentKeyboardState.IsKeyDown(Nocubeless.Settings.Keys.MoveDown)) 
        ...
        private void Rotate()
        {
            ...
            var deltaPoint = new Point(GameInput.CurrentMouseState.X - middlePoint.X,
                GameInput.CurrentMouseState.Y - middlePoint.Y);
